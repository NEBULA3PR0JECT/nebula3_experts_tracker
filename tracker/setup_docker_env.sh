...
## setup everything on the base env since in docker we only have
## on env 'to rule them all'
...
function install_engines_on_env {
    echo "============================================="
    ...
    install_detectron
    install_tracking
    # install_remote - already exists in base expert
